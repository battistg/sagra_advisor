...
# Dati demo (aggiornati con la Sagra di San Isidoro di Schiavon)
sagre = {
    "2025-05-16": [
        {
            "nome": "Sagra di San Isidoro di Schiavon (VI)",
            "menu_foto": ["/mnt/data/IMG_0273.jpeg"],
            "piatti_foto": [
                "/mnt/data/IMG_0266.jpeg",
                "/mnt/data/IMG_0267.jpeg"
            ],
            "menu": {
                ...
                "Pizze varie (es. Margherita, Patatosa, Salamin, ecc.)": "5,50-7,50€",
                "Birre (33cl)": "3,50-4,00€",
                "Caraffe vino": "6,00-9,00€",
                "Spritz/Gin/Caffè": "1,30-3,00€"
            },
            ...
            "voti": {
                ...
                "Location": "7/10 - Ordinata e accogliente, mancano i cestini"
            }
        }
    ]
}
